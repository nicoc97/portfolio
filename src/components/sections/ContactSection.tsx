        ...
        <div className="text-left space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12">
            ...
            <div ref={contactDetailsRef} className="space-y-6">
              ...
              {/* Email */}
              <div
                className={`contact-card group ${getStaggeredClasses(0, 'slide')}`}
              ...
              {/* Phone */}
              <div
                className={`contact-card group ${getStaggeredClasses(2, 'slide')}`}
            ...
            <div ref={socialLinksRef} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className={`contact-card-green group block hover:scale-105 transition-transform duration-200 ${getSocialClasses(0, 'slide')}`}
                >
                  <div className="icon-container-green">
                    {/* Pixel GitHub Icon */}
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`contact-card group block hover:scale-105 transition-transform duration-200 ${getSocialClasses(1, 'slide')}`}
                >
                  <div className="icon-container-orange">
                    {/* Pixel LinkedIn Icon */}
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
