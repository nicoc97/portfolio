        ...
        <div className="text-left space-y-8">
          ...
          <div ref={contentRef} className={`animate-slide-up ${contentVisible ? 'visible' : ''} mt-16`}>
            <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              ...
              {/* Email */}
              <div
                className="bg-primary-bg/50 backdrop-blur-sm rounded-lg border border-gray-600/20 hover:border-accent-orange/30 p-6 transition-all duration-300 cursor-pointer group hover:scale-105 hover:shadow-lg hover:shadow-accent-orange/10"
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-white font-tech text-base lg:text-base xl:text-lg font-semibold">
                      nico@example.com
                    </p>
              ...
              {/* Location */}
              <div className="bg-primary-bg/50 backdrop-blur-sm rounded-lg border border-gray-600/20 hover:border-accent-green/30 p-6 transition-all duration-300 group hover:scale-105 hover:shadow-lg hover:shadow-accent-green/10">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-accent-green/10 text-accent-green rounded-lg flex items-center justify-center border border-accent-green/20 group-hover:bg-accent-green/20 transition-all duration-300">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
              ...
              <a
                ...
                className="bg-primary-bg/50 backdrop-blur-sm rounded-lg border border-gray-600/20 hover:border-accent-green/30 p-6 transition-all duration-300 group hover:scale-105 hover:shadow-lg hover:shadow-accent-green/10 block"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-accent-green/10 text-accent-green rounded-lg flex items-center justify-center border border-accent-green/20 group-hover:bg-accent-green/20 transition-all duration-300">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-500 text-sm">Code & projects</p>
                  </div>
                </div>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-primary-bg/50 backdrop-blur-sm rounded-lg border border-gray-600/20 hover:border-accent-orange/30 p-6 transition-all duration-300 group hover:scale-105 hover:shadow-lg hover:shadow-accent-orange/10 block"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-accent-orange/10 text-accent-orange rounded-lg flex items-center justify-center border border-accent-orange/20 group-hover:bg-accent-orange/20 transition-all duration-300">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-500 text-sm">Professional network</p>
                  </div>
                </div>
              </a>
              ...
              <div className="md:col-span-2 lg:col-span-2 xl:col-span-1">
                <button
                  ...
                  className="w-full h-full min-h-[80px] bg-primary-bg/50 backdrop-blur-sm rounded-lg border border-gray-600/20 hover:border-accent-green/30 p-6 transition-all duration-300 group hover:scale-105 hover:shadow-lg hover:shadow-accent-green/10 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isDownloading ? (
                    <div className="flex items-center justify-center space-x-2 text-accent-green">
                      ...
                      <span className="font-tech uppercase tracking-wider">DOWNLOADING...</span>
                    </div>
                  ) : (
                    <div className="flex flex-col items-center space-y-1 text-white group-hover:text-accent-green transition-colors duration-300">
                      <span className="font-tech text-lg uppercase tracking-wider font-bold">DOWNLOAD CV</span>
                      <span className="text-xs opacity-75 text-gray-500">PDF • 2MB</span>
                    </div>
                  )}
                </button>
              </div>
          ...
          {/* Copy Feedback */}
          {copyFeedback && (
            <div className="fixed bottom-8 right-8 bg-accent-green text-primary-bg px-4 py-2 rounded-lg font-tech text-sm z-50 shadow-lg">
              {copyFeedback}
            </div>
          )}
