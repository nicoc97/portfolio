    ...
    <section id="contact" className="section-fullscreen py-20 bg-primary-bg relative overflow-hidden">
      <div className="w-full lg:w-3/5 mx-auto mobile-padding relative z-10">
        <div className="text-left space-y-8">
          ...
          {/* Contact Information - Staggered Asymmetrical Layout */}
          <div ref={contactDetailsRef} className="space-y-16 lg:space-y-20 mt-16">

            {/* Email - Full width, left aligned */}
            <div className={`max-w-2xl ${getStaggeredClasses(0, 'slide')}`}>
              <div
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-text-primary font-tech text-xl font-semibold">
                    nico@example.com
                  </p>
                  <p className="text-text-secondary text-sm">Primary contact • Click to copy</p>
                </div>
            ...
            {/* Phone & Location - Side by side, offset right */}
            <div className="lg:ml-16 xl:ml-24">
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12">

                {/* Phone */}
                <div className={`${getStaggeredClasses(1, 'slide')}`}>
                  <div
                    className="contact-card group"
                ...
                {/* Location */}
                <div className={`${getStaggeredClasses(2, 'slide')}`}>
            ...
            {/* Social Links - Offset left, larger cards */}
            <div ref={socialLinksRef} className="lg:ml-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">

                {/* GitHub */}
                <div className={`${getSocialClasses(0, 'slide')}`}>
                  <a
                  ...
                  >
                    ...
                    <div className="text-accent-green opacity-60 group-hover:opacity-100 transition-opacity">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <div className={`${getSocialClasses(1, 'slide')}`}>
                  <a
                ...
                {/* CV Download */}
                <div className={`md:col-span-2 lg:col-span-1 ${getSocialClasses(2, 'scale')}`}>
                  <PixelButton
                    variant="primary"
                    size="lg"
